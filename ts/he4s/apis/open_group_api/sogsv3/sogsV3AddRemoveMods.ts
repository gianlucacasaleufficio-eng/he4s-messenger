 ...
 * TODO: We do not support adding as moderators/visible/global for now in he4s desktop
 */
    ...
    [
      {
        ...
        addRemoveModerators: {
          he4sIds: usersToAddAsMods.map(m => m.key),
 ...
 * TODO: We do not support removing as moderators/visible/global for now in he4s desktop
 */
    ...
    [
      {
        type: 'addRemoveModerators',
        addRemoveModerators: {
          he4sIds: usersToRemoveFromMods.map(m => m.key),
          roomId: roomInfos.roomId,
          type: 'remove_mods',
        },
      },
