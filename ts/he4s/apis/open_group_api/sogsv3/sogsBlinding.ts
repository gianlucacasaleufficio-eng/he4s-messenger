...
async function decryptWithHE4SBlindingProtocol(
  data: Uint8Array,
  isOutgoing: boolean,
  ...
  const senderHE4SIdBytes = toX25519(senderEdpk, sodium);

  return { plainText, senderUnblinded: `${KeyPrefixType.standard}${to_hex(senderHE4SIdBytes)}` };
}
...
export const SogsBlinding = {
  ...
  decryptWithHE4SBlindingProtocol,
};
