...
import { BlindingActions } from '../../../webworker/workers/browser/libhe4s_worker_interface';
...
export const fileServerHost = 'filev2.gethe4s.org';
...
const RELEASE_VERSION_ENDPOINT = '/he4s_version?platform=desktop';
...
export const downloadFileFromFileServer = async (
  ...
  if (window.he4sFeatureFlags?.debug.debugFileServerRequests) {
