...
let cachedIdentityKeyPair: HE4SKeyPair | undefined;

/**
 * This return the stored x25519 identity keypair for the current logged in user
 */
export async function getIdentityKeyPair(): Promise<HE4SKeyPair | undefined> {
...
export function getOurProfile(): LokiProfile | undefined {
  try {
    ...
    const displayName = ourConversation.getRealHE4SUsername() || 'Anonymous';
    return {
      displayName,
      avatarPointer,
