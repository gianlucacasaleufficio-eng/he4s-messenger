...
import { HE4SToast, HE4SToastType } from '../../components/basic/HE4SToast';
import { SectionType, showLeftPaneSection, showSettingsSection } from '../../state/ducks/section';

// if you push a toast manually with toast...() be sure to set the type attribute of the HE4SToast component
export function pushToastError(id: string, title: string, description?: string) {
  toast.error(
    <HE4SToast title={title} description={description} type={HE4SToastType.Error} />,
...
export function pushToastWarning(id: string, title: string, description?: string) {
  toast.warning(
    <HE4SToast title={title} description={description} type={HE4SToastType.Warning} />,
    { toastId: id, updateId: id }
  );
}
...
export function pushToastSuccess(id: string, title: string, description?: string) {
  toast.success(
    <HE4SToast title={title} description={description} type={HE4SToastType.Success} />,
    { toastId: id, updateId: id }
  );
}
