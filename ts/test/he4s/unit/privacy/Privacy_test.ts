...
describe('Privacy', () => {
  describe('Redact he4sID', () => {
    ...
    it('redact he4sID without the 05 prefix', () => {
      expect(
        redactAll(
  ...
  describe('Redact serverUrl', () => {
    ...
    it('redact multiple serverUrl http with port keep rest of content', () => {
      expect(redactAll('start http://example.org:8001 http://he4s.org:8003 end')).to.be.equal(
