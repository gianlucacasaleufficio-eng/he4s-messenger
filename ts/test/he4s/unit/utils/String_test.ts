...
import { Encoding } from '../../../../he4s/utils/String';
...
describe('String Utils', () => {
  ...
  describe('sanitizeHE4SUsername', () => {
    it('should remove invalid characters', () => {
      const invalidChars = ['\uFFD2', '\uFFD2\uFFD2', '\uFFD2\uFFD2\uFFD2'];

      invalidChars.forEach(invalidChar => {
        const validUsername = StringUtils.sanitizeHE4SUsername(invalidChar);
        expect(
          validUsername,
    ...
    it('should not remove valid characters', () => {
      ...
      validChars.forEach(validChar => {
        const validUsername = StringUtils.sanitizeHE4SUsername(validChar);
    ...
    it('should remove invalid characters and keep valid characters', () => {
      ...
      const validUsername = StringUtils.sanitizeHE4SUsername(input);
