...
import { KeyPrefixType } from '../../../../he4s/types';
import { StringUtils } from '../../../../he4s/utils';
import { ByteKeyPair } from '../../../../he4s/utils/User';
 ...
 *
 * The function you are looking for is `decryptWithHE4SBlindingProtocol`
...
> => {
  ...
  const senderHE4SId = `${KeyPrefixType.standard}${to_hex(
