...
import { concatUInt8Array, getSodiumRenderer, MessageEncrypter } from '../../../../he4s/crypto';
...
describe('MessageEncrypter', () => {
  ...
  describe('HE4S Protocol', () => {
    ...
    it('should pass the padded message body to encrypt', async () => {
      const data = crypto.randomBytes(10);
      const spy = sinon.spy(MessageEncrypter, 'encryptUsingHE4SProtocol');
    ...
    it('should pass the correct data for sodium crypto_sign', async () => {
      ...
      await MessageEncrypter.encryptUsingHE4SProtocol(recipient, plainTextBytes);
    ...
    it('should return valid decodable ciphertext', async () => {
      ...
      const ciphertext = await MessageEncrypter.encryptUsingHE4SProtocol(
