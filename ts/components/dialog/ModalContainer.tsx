...
import { HE4SConfirm } from './HE4SConfirm';
import { HE4SNicknameDialog } from './HE4SNicknameDialog';
import { HE4SSetPasswordDialog } from './HE4SSetPasswordDialog';
...
export const ModalContainer = () => {
  ...
  const he4sPasswordModalState = useSelector(getHE4SPasswordDialog);
  ...
  return (
    <>
      ...
      {changeNicknameModal && <HE4SNicknameDialog {...changeNicknameModal} />}
      ...
      {he4sPasswordModalState && <HE4SSetPasswordDialog {...he4sPasswordModalState} />}
      {deleteAccountModalState && <DeleteAccountModal {...deleteAccountModalState} />}
      {confirmModalState && <HE4SConfirm {...confirmModalState} />}
