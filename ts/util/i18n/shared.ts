...
/**
 * Returns the current locale as supported by HE4S (i.e. one generated by crowdin)
 */
...
export function getBrowserLocale() {
  ...
  try {
    ...
    try {
      ...
      // see https://github.com/oxen-io/he4s-desktop/issues/3221
...
export function isHE4SLocaleSet() {
  return !!crowdinLocale;
}
